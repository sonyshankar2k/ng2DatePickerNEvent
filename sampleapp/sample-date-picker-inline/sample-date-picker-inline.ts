...
export class SampleDatePickerInline implements OnInit {
    ...
    private ng2datepickerneventInlineOptions: IMyOptions = {
        inline: true,
    ...
    onDisablePast(checked:boolean) {
        ...
        this.ng2datepickerneventInlineOptions = copy;
    }
    ...
    getCopyOfOptions(): IMyOptions {
        return JSON.parse(JSON.stringify(this.ng2datepickerneventInlineOptions));
    }
