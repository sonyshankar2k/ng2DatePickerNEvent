...
## Description
Highly configurable Angular2 date picker. Online demo is [here](http://kekeh.github.io/ng2datepickernevent)

If you want to set own styles to the input box, the calendar and the clear buttons you can try [this](https://github.com/kekeh/ngx-ng2datepickernevent)
...
1. __npm install ng2datepickernevent --save__

2. Add __ng2datepickerneventModule__ import to your __@NgModule__ like example below
    ```ts
    import { NgModule } from '@angular/core';
    import { BrowserModule } from '@angular/platform-browser';
    import { MyTestApp } from './my-test-app';
    import { ng2datepickerneventModule } from 'ng2datepickernevent';

    @NgModule({
        imports:      [ BrowserModule, ng2datepickerneventModule ],
...
3. If you are using __systemjs__ package loader add the following ng2datepickernevent properties to the __System.config__:
    ```js
    (function (global) {
        System.config({
            paths: {
            ...
            map: {
                ...
                'ng2datepickernevent': 'npm:ng2datepickernevent/bundles/ng2datepickernevent.umd.js'
            },
            packages: {
            }
        });
...
In this option the ngModel binding is used. [Here](https://github.com/kekeh/ng2datepickernevent/tree/master/sampleapp/sample-date-picker-access-modifier)
is an example application. It shows how to use the __ngModel__.

To use ngModel define the application class as follows:

```ts
import {IMyOptions} from 'ng2datepickernevent';
// other imports here...

export class MyTestApp {

    private ng2datepickerneventOptions: IMyOptions = {
        // other options...
...
<form #myForm="ngForm" novalidate>
    <my-date-picker name="mydate" [options]="ng2datepickerneventOptions"
...
In this option the value accessor of reactive forms is used. [Here](https://github.com/kekeh/ng2datepickernevent/tree/master/sampleapp/sample-date-picker-access-modifier)
...
In this option the ng2datepickernevent sends data back to host application using callbacks. [Here](https://github.com/kekeh/ng2datepickernevent/tree/master/sampleapp/sample-date-picker-normal)
is an example application. It shows how to use callbacks.

To use callbacks define the application class as follows:

```js
import {IMyOptions, IMyDateModel} from 'ng2datepickernevent';
// other imports here...
...
```html
<my-date-picker [options]="ng2datepickerneventOptions"
...
Value of the __options__ attribute is a type of [IMyOptions](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-options.interface.ts). It can contain the following properties.

| Option        | Default       | Type   | Description  |
| :------------ | :------------ | :----- | :--------- |
| __dayLabels__     | {su: 'Sun', mo: 'Mon', tu: 'Tue', we: 'Wed', th: 'Thu', fr: 'Fri', sa: 'Sat'} | [IMyDayLabels](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-day-labels.interface.ts) | Day labels visible on the selector. |
| __monthLabels__   | { 1: 'Jan', 2: 'Feb', 3: 'Mar', 4: 'Apr', 5: 'May', 6: 'Jun', 7: 'Jul', 8: 'Aug', 9: 'Sep', 10: 'Oct', 11: 'Nov', 12: 'Dec' } | [IMyMonthLabels](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-month-labels.interface.ts) | Month labels visible on the selector. |
...
| __disableUntil__   | no default value | [IMyDate](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-date.interface.ts) | Disable dates backward starting from the given date. For example: {year: 2016, month: 6, day: 26} |
| __disableSince__   | no default value | [IMyDate](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-date.interface.ts) | Disable dates forward starting from the given date. For example: {year: 2016, month: 7, day: 22} |
| __disableDays__   | no default value  | Array<[IMyDate](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-date.interface.ts)> | Disable single dates one by one. Array of disabled dates. For example: [{year: 2016, month: 11, day: 14}, {year: 2016, month: 1, day: 15}] |
| __enableDays__   | no default value  | Array<[IMyDate](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-date.interface.ts)> | Enable given dates one by one if the date is disabled. For example if you disable the date range and want to enable some dates in range. Array of enabled days. For example: [{year: 2016, month: 11, day: 14}, {year: 2016, month: 1, day: 15}] |
| __disableDateRanges__   | no default value | Array<[IMyDateRange](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-date-range.interface.ts)> | Disable date ranges. For example: [{begin: {year: 2016, month: 11, day: 14}, end: {year: 2016, month: 11, day: 20}}] |
...
| __inline__   | false | boolean | Show ng2datepickernevent in inline mode. |
| __showClearDateBtn__   | true | boolean | Is clear date button shown or not. Can be used if __inline = false__. |
| __height__   | 34px | string | ng2datepickernevent height in without selector. Can be used if __inline = false__. |
| __width__   | 100% | string | ng2datepickernevent width. Can be used if __inline = false__. |
...
```ts
  ng2datepickerneventOptions: IMyOptions = {
      todayBtnTxt: 'Today',
...
* new locale data can be added to [this](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/services/my-date-picker.locale.service.ts)
file. If you want to add a new locale create a pull request.
* locales can be tested [here](http://kekeh.github.io/ng2datepickernevent/#inlinemode)
...
Type of the __selDate__ attribute can be a string or an [IMyDate](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-date.interface.ts) object.
...
[Here](https://github.com/kekeh/ng2datepickernevent/wiki/Initialize-with-selDate-attribute) is an example on how to use this attribute.
...
[Here](https://github.com/kekeh/ng2datepickernevent/wiki/Initialize-with-defaultMonth-attribute) is an example on how to use this attribute.

### placeholder attribute

Placeholder text in the input field. [Here](https://github.com/kekeh/ng2datepickernevent/wiki/Set-placeholder) is an example on how to use this attribute.

### selector attribute

Selector can be opened or closed using this attribute. [Here](https://github.com/kekeh/ng2datepickernevent/wiki/Open-selector-with-selector-attribute) is an example on how to use this attribute.
Another way is to call a function of ng2datepickernevent. [Here](https://github.com/kekeh/ng2datepickernevent/wiki/Calling-date-picker-function) is an example.
...
### dateChanged callback
  ...
  * event parameter type is [IMyDateModel](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-date-model.interface.ts)
...
### inputFieldChanged callback
  ...
  * event parameter type is [IMyInputFieldChanged](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-input-field-changed.interface.ts)
...
### calendarViewChanged callback
  ...
  * event parameter:
    ...
    * event.first: First day of selected month and year. Type of [IMyWeekday](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-weekday.interface.ts). For example: {number: 1, weekday: "tu"}
    * event.last: Last day of selected month and year. Type of [IMyWeekday](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-weekday.interface.ts). For example: {number: 30, weekday: "we"}
  * event parameter type is [IMyCalendarViewChanged](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-calendar-view-changed.interface.ts)
...
### inputFocusBlur callback
  ...
  * event parameter:
    ...
    * event parameter type is [IMyInputFocusBlur](https://github.com/kekeh/ng2datepickernevent/blob/master/src/my-date-picker/interfaces/my-input-focus-blur.interface.ts)
...
The [sampleapp](https://github.com/kekeh/ng2datepickernevent/tree/master/sampleapp) of the component contain an example:

* [override.css](https://github.com/kekeh/ng2datepickernevent/blob/master/sampleapp/override.css) contain the changed styles.
* [index.html](https://github.com/kekeh/ng2datepickernevent/blob/master/sampleapp/index.html) contain import of the override.css file.
...
* Build a local npm installation package:
  ...
  2. __cd npmdist__
  3. __npm pack__
    * local installation package is created to the __npmdist__ folder. For example: __ng2datepickernevent-1.1.1.tgz__

* Install local npm package to your project:
  1. __npm install path_to_npmdist/ng2datepickernevent-1.1.1.tgz__
