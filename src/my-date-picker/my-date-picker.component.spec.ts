...
let comp: ng2datepickernevent;
let fixture: ComponentFixture<ng2datepickernevent>;
let de: DebugElement;
let el: HTMLElement;
...
describe('ng2datepickernevent', () => {
    beforeEach(() => {
        TestBed.configureTestingModule({
            declarations: [ng2datepickernevent, FocusDirective, InputAutoFillDirective],
        });

        fixture = TestBed.createComponent(ng2datepickernevent);
